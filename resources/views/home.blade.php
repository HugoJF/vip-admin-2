                    ...
                    <div class="flex flex-col items-center w-100 p-8">
                        ...
                        <div>
                            <h4 class="flex items-baseline text-5xl">
                                ...
                                <span class="font-semibold text-grey-darkest">{{ number_format($product->cost * (1 - $product->discount) / 100, 2) }}</span>
                                @if($product->discount > 0)
                                    <span class="ml-2 font-normal text-red-700 line-through">{{ number_format($product->cost / 100, 2) }}</span>
                                @endif
